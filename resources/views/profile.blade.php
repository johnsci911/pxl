...
<body class="bg-pxl-dark text-pxl-light flex sm:h-dvh gap-8 xl:gap-16 sm:overflow-clip px-4">
  <!-- Navigation -->
  <header class="sm:flex flex-col gap-8 hidden my-4 w-48 shrink-0 pl-4 xl:ml-40 justify-between">
      ...
      <nav class="mt-10">
        <ul class="flex flex-col gap-3.5">
          ...
          <li class="-ml-4 flex items-center gap-2">
            <div class="bg-pxl size-2 shrink-0"></div>
    ...
    <div class="flex flex-col gap-6">
      <button
        class="bg-pxl hover:bg-pxl/90 active:bg-pxl/95 text-pxl-dark border border-transparent px-4 py-3 text-sm">
        Post
      </button>
      <!-- User controls -->
      <div class="flex gap-3.5">
        ...
        <div class="flex flex-col gap-1 text-sm">
          <p>_adrian</p>
          <p class="text-pxl-light/60">@tudssss</p>
        </div>
          ...
          <div class="border-pxl-light/10 border-b pb-5">
            ...
            <div class="flex items-center justify-between gap-4">
              <div class="flex items-center gap-2.5">
                ...
                <p class="text-pxl-light/40 text-xs">3h</p>
                <p>
                  <a class="text-pxl-light/40 hover:text-pxl-light/60 text-xs" href="/profile">@mmich_jj</a>
                </p>
              </div>
              <button class="group flex gap-[3px] py-2" aria-label="Post options">
                <span class="bg-pxl-light/40 group-hover:bg-pxl-light/60 size-1"></span>
            ...
            <div class="mt-6 flex items-center justify-between gap-4">
              ...
              <div class="flex items-center gap-3">
                <!-- Save -->
                <div class="flex items-center gap-1">
                  <button aria-label="Save" class="hover:text-pxl">
                  ...
                  <span class="text-pxl-light/40 text-sm">Save</span>
                </div>
                <!-- Share -->
                <div class="flex items-center gap-1">
                  <button aria-label="Share" class="hover:text-pxl">
            ...
            <div class="border-pxl-light/10 bg-pxl-light/3 mt-8 flex items-start gap-4 border-t p-4">
              ...
              <form class="grow" action="">
                ...
                <div class="flex items-center justify-between gap-4">
                  ...
                  <button type="submit"
                    class="bg-pxl/10 hover:bg-pxl/15 active:bg-pxl/20 text-pxl border border-transparent px-4 py-1 text-sm">
                    Post
                  </button>
                </div>
              </form>
              ...
              <div class="border-pxl-light/10 grow border-b pt-1.5 pb-5">
                <div class="flex items-center justify-between gap-4">
                  <div class="flex items-center gap-2.5">
                    ...
                    <p class="text-pxl-light/40 text-xs">1h</p>
                    <p>
                      <a class="text-pxl-light/40 hover:text-pxl-light/60 text-xs" href="/profile">@simonswiss</a>
                    </p>
                  </div>
                  <button class="group flex gap-[3px] py-2" aria-label="Post options">
                    <span class="bg-pxl-light/40 group-hover:bg-pxl-light/60 size-1"></span>
  ...
  <!-- Sidebar -->
  <aside class="hidden lg:block my-4 w-80 shrink-0 overflow-y-auto px-4 -mx-4">
    ...
    <div class="border-pxl-light/10 mt-4 border p-4">
      <h2 class="text-pxl-light/60 text-sm">Follow Idea Streams</h2>
      <ol class="mt-4 flex flex-col gap-2.5">
        <li class="flex items-center justify-between gap-4">
          <p class="truncate text-sm">Breakfast ideas and whatever</p>
          <button
            class="bg-pxl-dark/50 hover:bg-pxl-dark/60 active:bg-pxl-dark/75 border-pxl/50 hover:border-pxl/60 active:border-pxl/75 text-pxl grid size-7 shrink-0 place-items-center border text-2xl leading-none">
            +
          </button>
        </li>
        <li class="flex items-center justify-between gap-4">
